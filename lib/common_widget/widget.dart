...
buildChoiceDetails(BuildContext context,String title,HomeController cont,List list, int index,String categoryFrom){
  return Padding(
    padding: const EdgeInsets.only(top: 10.0),
    child: GestureDetector(
      onTap: (){
        cont.navigateToSelected(list[index],categoryFrom);
        },
      child: Container(
        ...
        child: Padding(
          ...
          child: Center(
            child:buildTextRegularWidget(title, primaryColor, context, 15.0,align:TextAlign.center),
          ),
        ),
      ),
    ),
...
buildTableTitleForReport(BuildContext context,String title){
  return Container(
    color: grey,
    child: Padding(
      padding: const EdgeInsets.all(5.0),
